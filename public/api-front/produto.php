<html>
  ...
  <body>
      ...
      <div class="container">
          ...
          <a data-type="produtoView" data-id="<?php echo $_GET['id'] ?>" class="waves-effect waves-light btn-small" onclick="destroyThis(this)">Deletar</a>
          <a href="produtos-form.php?id=<?php echo $_GET['id'] ?>" class="waves-effect waves-light btn-small">Editar</a>
          <h5 id="populate-produto-codigo"></h5>
          <h4 id="populate-produto-nome"></h4>
          <h5 id="populate-produto-preco"></h5>
    ...
    <script type="text/javascript">
      getRegistro(<?php echo $_GET['id'] ?>, 'produtoView');
    </script>
  </body>
</html>
